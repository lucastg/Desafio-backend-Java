...
public class OrdersServiceImpl implements OrdersService{
    ...
    public OrdersServiceImpl(OrderRepository orderRepository, UsersRepository usersRepository, ProductsRepository productsRepository) {
    ...
    public Optional<OrderModel> updateItensOrder(UpdateItensOrderRequest updateItensOrderRequest) {
        ...
        if (orderOptional.isPresent()) {
            ...
            order.get().setPrecoTotal(totalPrice);
